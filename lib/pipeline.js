...
import promptOrtodossa from '../prompts/voce-ortodossa.md';
...
import canonOrtodossa from '../canon/ortodossa.md';
...
export function assemblaPrompt(voce, letture) {
  ...
  const sistema = PROMPTS[voce];
  const canone = CANONI[voce];
